...
public class SubmitOrderTestWithHashMap extends BaseTest {
	...
	@Test(dataProvider="getData", groups= {"PurchaseViaHashMap"})
	...
	public Object[][] getData() {
		...
		map.put("email","qwertasd@gmail.com" );
		map.put("password","Zxc@12345" );
		map.put("product","ZARA COAT 3" );
		
		HashMap<String, String> map1=new HashMap<String, String>();
		map1.put("email","yuiop@gmail.com" );
		map1.put("password","Zxc@12345" );
